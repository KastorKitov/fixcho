...
export default function EditJob() {
    ...
    useEffect(() => {
        if (job) {
            ...
            setEmail(job.email);
            setPhoneNumber(job.phone_number || "");
            setImage(job.image_url || null);
            setNegotiable(job.negotiable);
            setMinPrice(job.min_price || "");
            setMaxPrice(job.max_price || "");
    ...
    return (
        <SafeAreaView style={{ flex: 1 }} edges={['left', 'right']}>
            ...
            >
                ...
                >
                    {/* Subtitle */}
                    <Text style={styles.subtitle}>How do you want to edit it?</Text>
